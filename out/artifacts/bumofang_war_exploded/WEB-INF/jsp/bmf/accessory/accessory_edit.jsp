...
<script type="text/javascript">
	var fieldArray = ["NUMBER","NAME","CATEGORY","MATERIAL","SKU","SERIES","FLAT_PICTURE","ART_PICTURE","USE_LABELS","COLOR_LABELS","STYLE_TAGS","COLLOCATION_TAGS","DESIGN_TAGS","OTHER_TAGS","PRICE","REMARK",""];
	...
	function save(target){
		...
		if($("#CATEGORY").val()==""){
			popupTip('CATEGORY', '请输入品类');
			return false;
		}
		if($("#MATERIAL").val()==""){
			popupTip('MATERIAL', '请输入材质');
			return false;
		}
		if($("#SKU").val()==""){
			popupTip('SKU', '请输入规格');
...
<body>
	<form action="accessory/saveMulti.do" name="Form" id="Form" method="post" enctype="multipart/form-data" onsubmit="return save();">
		...
		<table id="table_report" class="table noline">
			...
			<tr>
				<td style="width:80px;text-align: right;padding-top: 13px;"><em>*</em>品类:</td>
				<td><input type="text" name="CATEGORY" id="CATEGORY" value="${pd.CATEGORY}" maxlength="32" placeholder="请输入品类" title="品类"/></td>
			...
			<tr>
				...
				<td><input type="text" name="MATERIAL" id="MATERIAL" value="${pd.MATERIAL}" maxlength="32" placeholder="请输入材质" title="材质"/></td>
			...
			<tr>
				<td style="width:80px;text-align: right;padding-top: 13px;"><em>*</em>规格:</td>
				<td><input type="text" name="SKU" id="SKU" value="${pd.SKU}" maxlength="32" placeholder="请输入规格" title="规格"/></td>
			...
			<tr>
				<td style="width:80px;text-align: right;padding-top: 13px;"><em>*</em>系列:</td>
				<td><input type="text" name="SERIES" id="SERIES" value="${pd.SERIES}" maxlength="32" placeholder="请输入系列" title="系列"/></td>
			...
			<tr>
				<td style="width:80px;text-align: right;padding-top: 13px;"><em>*</em>平面图片:</td>
