		...
		<table id="table_report" class="table noline">
			...
			<tr>
				...
				<td>
					...
					<label style="margin-left:80px;">宽幅</label>	
					<input type="text" class="input_len_short" name="productWidePrice" id="productWidePrice" value="${entity.productWidePrice}" /><label>元/米</label>			
				</td>
			</tr>
			<tr>
				<td >成份</td>
			...
			<tr>
				...
				<td>
					...
					<label style="margin-left:80px;">宽幅</label>
					<input type="text" class="input_len_short" name="productWideWidth" id="productWideWidth" value="${entity.productWideWidth}" /><label>cm ± 3cm</label>	
				</td>
			</tr>
			<tr>
				<td >水洗标志</td>
