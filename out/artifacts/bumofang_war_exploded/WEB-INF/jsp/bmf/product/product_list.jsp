...
<button class="btn btn-mini btn-info" onclick="return deleteProduct();" style="padding:0 30px; margin:3px 0 0 30px;" title="删除产品">删除产品</button>					
					...
					<c:if test="${isTestMode == true }">
						<button class="btn btn-mini btn-info add_member_cart"  onclick="return add_member_cart()" style="padding:0 30px; margin:3px 0 0 30px;" title="添加购物车">添加购物车</button>
					</c:if>
					<!-- <button class="btn btn-mini btn-info" onclick="return deleteProduct();" style="padding:0 30px; margin:3px 0 0 30px;" title="删除产品">删除产品</button> -->
				</div> 
			</div>
