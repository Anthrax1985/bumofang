package com.fh.controller.bmf.shopcart;
...
public class ShopcartController extends BaseController {
	...
	public String restSave(@RequestBody Map<String,String> map) throws Exception{
		logBefore(logger, "REST新增Shopcart");
	...
	public ModelAndView list(Page page){
		...
		try{
			...
			mv.setViewName("bmf/shopcart/shopcart_list");
			mv.addObject("pd", pd);
	...
	public ModelAndView goAdd(){
		logBefore(logger, "去新增Shopcart页面");
		ModelAndView mv = this.getModelAndView();
		PageData pd = new PageData();
		pd = this.getPageData();
		try {
			mv.setViewName("bmf/shopcart/shopcart_edit");
	...
	public ModelAndView goEdit(){
		logBefore(logger, "去修改Shopcart页面");
		ModelAndView mv = this.getModelAndView();
		PageData pd = new PageData();
		pd = this.getPageData();
		try {
	...
	public ModelAndView exportExcel(){
		logBefore(logger, "导出Shopcart到excel");
		...
		try{
			...
			for(int i=0;i<varOList.size();i++){
				...
				vpd.put("var5", varOList.get(i).getString("buy_id"));	//5
