...
public class RoleController extends BaseController {
	...
	public String auth(@RequestParam String ROLE_ID,Model model)throws Exception{
		...
		try{
			...
			json = json.replace("MENU_ID", "id").replace("MENU_NAME", "name").replace("subMenu", "nodes").replace("hasMenu", "checked");
	...
	@RequestMapping(value={"/rest/auth/edit"}, method={RequestMethod.POST}, produces={JSON_UTF8})
	@ResponseBody
	public String restSaveAuth(@RequestBody Map<String,String> map)throws Exception{
		PageData pd = new PageData();
	 ...
	 * 保存角色按钮权限
	 */
	@RequestMapping(value={"/rest/roleButton/edit"}, method={RequestMethod.POST}, produces={JSON_UTF8})
	@ResponseBody
	public String restEditRoleButton(@RequestBody Map<String,String> map)throws Exception{
		PageData pd = new PageData();
		String roleId = map.get("ROLE_ID");
		String menuIds = map.get("menuIds");
	 ...
	 * 编辑
	 */
	@RequestMapping(value={"/rest/edit"}, method={RequestMethod.POST}, produces={JSON_UTF8})
	@ResponseBody
	...
	@RequestMapping(value={"/rest/add"}, method={RequestMethod.POST}, produces={JSON_UTF8})
	@ResponseBody
	public String restAdd(@RequestBody Map<String,String> map)throws Exception{
		PageData pd = new PageData();
		try{
			pd.putAll(map);
