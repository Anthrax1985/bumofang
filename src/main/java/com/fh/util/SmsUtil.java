...
//		sendSms2("13511111111","您的验证码是：1111。请不要把验证码泄露给其他人。");
		...
		//sendSms1();
		sendSmsByRuiXingTong();
	}
	
	public static void sendSmsByRuiXingTong(){
		String postData = "";
		try {
			String message = "测试用的";
			
//			message = new String(message.getBytes(), "GBK");
			byte[] b = message.getBytes("8859_1"); //中间用ISO-8859-1过渡
			message = new String(b, "GB2312");
...
//			System.out.println(message);
			postData = "account=76110922&pwd=789789&product=12&mobile=13675892929&message=" + message;
		} catch (UnsupportedEncodingException e1) {
			// TODO Auto-generated catch block
			e1.printStackTrace();
		}
		String result = SMS(postData, "http://dx.10659com.com:83/ApiService.asmx/Send");
