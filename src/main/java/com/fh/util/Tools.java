...
public class Tools {
	...
	public static String getWhereIn(List<String> arr){
		String[] array = (String[])arr.toArray(new String[arr.size()]);
		String where_in = Arrays.stream(array).collect(Collectors.joining(","));
		return where_in;
	}
