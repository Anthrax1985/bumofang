...
<div class="container-fluid" id="main-container">
		<!-- 检索  -->
			...
			<form action="productdatastatistics/tableList/${status}/${periodTime}/${productId}/${memberId}" method="post" name="Form" id="Form">	
					...
					<c:when test="${not empty tableDetailList}">
						...
						<c:forEach items="${tableDetailList}" var="var" varStatus="vs">
							<tr>
								...
								<td>${var.orderCnt}</td>
								<td>${var.payCnt}</td>
								<td><fmt:formatNumber type="number" value="${var.payCnt/var.amount}" pattern="0.00"/>%</td>
								<td>${var.meter}</td>
