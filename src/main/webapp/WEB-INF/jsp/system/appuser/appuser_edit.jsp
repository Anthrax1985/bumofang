...
<body>
	<form action="happuser/${msg }.do" name="userForm" id="userForm" method="post">
		...
		<table class="table noline">
			...
			<tr>
				<td><input type="text" name="USERNAME" id="loginname" value="${pd.USERNAME }" placeholder="请输入用户名" title="用户名"/></td>
			...
			<tr>
				<td><input type="text" name="NUMBER" id="NUMBER" value="${pd.NUMBER }" maxlength="32" placeholder="请输入编号" title="编号" onblur="hasN('${pd.USERNAME }')"/></td>
				<td><input type="email" name="EMAIL" id="EMAIL"  value="${pd.EMAIL }" maxlength="32" placeholder="请输入邮箱" title="邮箱" onblur="hasE('${pd.USERNAME }')"/></td>
			</tr>
			
			<tr>
				<td><input type="password" name="PASSWORD" id="password"  placeholder="输入密码"  title="密码"/></td>
				<td><input type="tel" name="PHONE" id="PHONE" value="${pd.PHONE }" placeholder="请输入手机号" title="手机号"/></td>
			</tr>
			<tr>
				<td><input type="password" name="chkpwd" id="chkpwd"  placeholder="确认密码"  title="确认密码"/></td>
				<td><input type="text" name="SFID" id="SFID" value="${pd.SFID }" placeholder="请输入身份证号" title="身份证号" /></td>
			</tr>
			<tr>
				<td><input type="text" name="NAME" id="name"  value="${pd.NAME }" placeholder="请输入姓名" title="姓名" /></td>
				<td><input type="number" name="YEARS" id="YEARS" class="input_txt" value="${pd.YEARS }" placeholder="开通年限(请输入数字)" title="开通年限" /></td>
			</tr>
			<tr>
				<td><input type="text" name="BZ" id="BZ"value="${pd.BZ }" placeholder="请输入备注" title="备注"/></td>
				<td>
			...
			<tr>
				<td class="center" colspan="2">
					<a id="saveBtn" class="btn btn-primary" style="width:100px;" onclick="save();">保  存</a>
				</td>
			</tr>
		</table>
		</div>
