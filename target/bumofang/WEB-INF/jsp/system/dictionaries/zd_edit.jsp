...
<body>
	<form  action="dictionaries/save.do" name="Form" id="Form" method="post" >
		...
		<table class="table noline">
			<tr >
				<td><input type="text" name="NAME" id="NAME" placeholder="请输入名称" value="${pd.NAME }" title="名称"/></td>
			</tr>
			<tr class="info">
				<td><input type="text" name="BIANMA" id="BIANMA" placeholder="请输入编码" value="${pd.BIANMA }" title="编码"/></td>
			</tr>
			<tr class="info">
				<td><input type="number" name="ORDY_BY" id="ORDY_BY" placeholder="请输入序号" value="${pd.ORDY_BY}" title="序号"/></td>
			</tr>
			<tr>
