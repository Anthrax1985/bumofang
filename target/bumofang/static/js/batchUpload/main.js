...
$(function() {
  var uploader = Qiniu.uploader({
    ...
    // },
    domain: $('#domain').val(),
    imgProductDomain: $('#imgProductDomain').val(),
    imgD3dDomain: $('#imgD3dDomain').val(),
    imgSceneDomain: $('#imgSceneDomain').val(),
    ...
    init: {
      ...
      'FilesAdded': function(up, files) {
        ...
        // var ajaxObject = {};
        // ajaxObject.url = "productPicUpload/rest/remove";
        // ajaxObject.data = {
        //   name_list : arr
        // };
        //
      ...
      'FileUploaded': function(up, file, info) {
        ...
        var file_name = res.key;

        var ajaxObject = {};
        ajaxObject.url = "productPicUpload/rest/uploadComplete";
        ajaxObject.data = {
          file_name:file_name
        };
        ajaxObject.success = function(result){
