	...
	function appendC(value){
		...
		$("#fields").append(
			...
			'<td class="center">'+
				...
				'<a class="btn btn-mini btn-info" title="编辑" onclick="editField(\''+value+'\',\''+index+'\')"><i class="fa fa-edit"></i></a>&nbsp;'+
				'<a class="btn btn-mini btn-danger" title="删除" onclick="removeField(\''+index+'\')"><i class="fa fa-trash"></i></a>'+
			'</td>'+
			'</tr>'
		);
		index++;
